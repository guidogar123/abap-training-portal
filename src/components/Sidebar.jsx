...
import { ChevronRight, ChevronDown, BookOpen, Hexagon } from 'lucide-react';

const Sidebar = ({ weeks, currentSession, onSelectSession, isOpen, toggleSidebar }) => {
    ...
    `}>
            ...
            <div className="overflow-y-auto h-[calc(100vh-88px)] p-4 space-y-2">
                {weeks.map((week) => (
